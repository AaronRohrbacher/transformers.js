...
export class Processor extends Processor_base {
     ...
     */
    decode(token_ids: number[] | import("./transformers.js").Tensor | bigint[], decode_args?: {
...
export type PreTrainedTokenizer = import("./tokenization_utils.js").PreTrainedTokenizer;
export {};
